...
* <strong><span style="color:darkblue">Algorithmics and data structures</span></strong>: troduction of the basic data structures and of the basic algorithms that manage them. Trees, Graphs, Sort, etc. Technology: `C`
